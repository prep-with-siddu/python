...
print("hello" and "world")   # "world"  (both truthy → last)
print("" and "world")        # ""       (first falsy → returns it)
print("hello" or "world")    # "hello"  (first truthy → returns it)
print("" or "world")         # "world"  (first falsy → check second)
...
# ---- When to use 'is' vs '==' ----
# is    → checking for None, True, False, singletons
...
# set:  O(1)  — hash lookup (use sets for frequent lookups!)
