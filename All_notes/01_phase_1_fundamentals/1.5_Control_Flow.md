...
| # | Video | Creator | Lang |
|---|-------|---------|------|
| 1 | [Conditionals and Booleans — If, Else, Elif](https://www.youtube.com/watch?v=DZwmZ8Usvnk) | Corey Schafer | 🇬🇧 |
...
# ✅ BETTER: Flatten nested conditions when possible
...
# ✅ Guard clause pattern (early return — great for functions!)
...
x = 10
def test():
    # print(x)    # ❌ UnboundLocalError if you also assign x below!
...
# nonlocal x   → access enclosing function's x
```

---

> 📝 **Next up**: 1.6 Loops & Built-in Functions
