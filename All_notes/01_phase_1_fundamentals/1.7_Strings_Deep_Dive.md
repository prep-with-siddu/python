...
| # | Video | Creator | Lang |
|---|-------|---------|------|
| 1 | [Strings — Working with Textual Data](https://www.youtube.com/watch?v=k9TUPpGqYTo) | Corey Schafer | 🇬🇧 |
| 2 | [`re` Module — Regular Expressions (Regex)](https://www.youtube.com/watch?v=K8L6KVGG-7o) | Corey Schafer | 🇬🇧 |
...
print(f"{name!s}")            # "Sid" (str — default)
...
# 3. Python can optimize: same value → same object (interning)
...
print(decoded)    # "Hello, Sid! 🇮🇳"

# ---- Common encodings ----
# utf-8   — universal, supports all characters ✅ (default!)
# ascii   — English only (0-127)
# latin-1 — Western European
# utf-16  — Windows internal

# ---- Encoding errors ----
"Hello 🇮🇳".encode("ascii")          # ❌ UnicodeEncodeError!
"Hello 🇮🇳".encode("ascii", errors="ignore")   # b'Hello '
"Hello 🇮🇳".encode("ascii", errors="replace")  # b'Hello ????'
...
# ['10', '20', '50'] — careful with partial matches!
...
> 📝 **Next up**: 1.8 Date & Time (Backend Essential)
