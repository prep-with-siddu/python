...
| # | Video | Creator | Lang |
|---|-------|---------|------|
| 1 | [Python Requests Tutorial — Web Pages, POST, JSON, Download](https://www.youtube.com/watch?v=tb8gHvYlCFs) | Corey Schafer | 🇬🇧 |
...
# Session reuses TCP connections → MUCH faster for multiple requests!
...
| Async | ❌ | ✅ |
| HTTP/2 | ❌ | ✅ |
| Streaming | Basic | Full async ✅ |
| API | Standard | requests-compatible |
| Use | Simple scripts | Modern async apps ✅ |
...
> 💡 You rarely use urllib3 directly — but understanding it helps debug requests/httpx issues.
...
class CircuitState(Enum):
    ...
    OPEN = "open"            # Broken — reject requests immediately
...
# 2. Return 200 quickly — process async for heavy work
...
> 📝 **Phase 7 Complete!** Next: Phase 8 — Git, Testing & Code Quality
